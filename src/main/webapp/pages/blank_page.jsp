...
<div class="blank-page">
    ...
    <div class="blank-page-body">
        ...
        <main class="blank-page-main" id="main">
            <header class="blank-page-header">
                <div class="blank-page-header-left">
                    <span class="blank-page-header-left-welcome">Blank Page</span>
                    <span>Create your new page based on this starter page.</span>
                </div>
                <div class="blank-page-header-right">
                    <a href="dashboard"><i class="fa fa-home"></i>Home</a>
                    <span> / Blank Page </span>
                </div>
            </header>
            <div class="blank-page-main-content">
                <div class="blank-page-main-content-header">
                    <span>Page Heading</span>
                    <span class="blank-page-main-title">Page Title</span>
                </div>
                <div class="blank-page-main-content-details">
