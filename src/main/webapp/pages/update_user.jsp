                ...
                <form class="user-form" action="Update" method="post">
                    <div class="user-information-with-header">
                        ...
                        <div class="user-information">
                            ...
                            <div class="user-details">
                                <span>Gender</span>
                                <select required name="gender" class="js-states form-control user-input" id="user-gender-input">
                            ...
                            <div class="user-details">
                                <span>Country</span>
                                <select required name="country" class="js-states form-control user-input" id="user-country-input">
                                    <option value disabled selected>-- Select --</option>
...
<script>
    $("#user-country-input").select2({});
    $("#user-gender-input").select2({});
</script>
</body>
</html>
